...
export default {
	...
	data () {
		return {
			...
			translate: {
				...
				gst_in: "GST IN",
				unit_maching_field: "Unit Maching Field",
	...
	created: async function () {
		...
		let all_companies = await this.$axios
			.$get("/api/v1/evolve/Unit/getCompanyList")
			.catch((e) => {
