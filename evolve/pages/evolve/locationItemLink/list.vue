	...
	<div>
		...
		<div class="evolve-page-header">
			<div class="evolve-page-header-icons">
				<a class="sc-actions-icon mdi mdi-refresh  md-color-light-green-600" @click="getLocationList()"></a>
...
export default {
	head () {
		return {
			...
			pageURL : '/mdm/locationItemLink/create',
		};
	},
	layout: "eDefaultV2",
	components: {
	...
	data () {
		return {
			translate: {
				pageURL: "/mdm/locationItemLink/list/",
	...
	methods: {
		...
		addLocation: async function (id) {
			...
			this.$store.dispatch('addNewTab', {
				...
				url: '/evolve/locationItemLink/create',
				params: {
					id: id,
				}
			});
