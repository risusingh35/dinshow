										...
										<table id="evolveCustomerMaster" class="uk-table uk-table-striped">
											<thead>
												<tr>
													...
													<th>{{ translate.customer_state }}</th>
													...
													<th>{{ translate.customer_is_active }}</th>
													<th>{{ translate.customer_currency }}</th>
													<th>{{ translate.customer_shipvia }}</th>
													<th>{{ translate.customer_remarks }}</th>
												</tr>
											</thead>
											<tbody>
...
export default {
	...
	data () {
		return {
			translate: {
				...
				email: "Email",
				gstin: "GST IN",
				customer_is_active: "Is Active",
				customer_currency: "Currency",
				customer_remarks: "Remarks",
				customer_shipvia: "Ship Via",
			},
			dateRange: "",
	...
	methods: {
		...
		async downloadPdf () {
			...
			let rows = document.querySelectorAll("#evolveCustomer table tr");
		...
		async getCustomerList () {
			let getCustomerList = await this.$axios
