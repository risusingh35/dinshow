...
export default {
	...
	props: {
		pallete: {
			...
			default: function () {
				return [
					'#e53935', '#d81b60', '#8e24aa', '#5e35b1', '#3949ab', '#1e88e5', '#039be5', '#0097a7', '#00897b', '#43a047', '#689f38', '#ef6c00', '#f4511e', '#6d4c41', '#757575', '#546e7a', '#FFFFFF', '#000000'
				]
			}
		},
		value: {
...
<style scoped lang="scss">
	@import "../assets/scss/common/_variables_mixins.scss";
	@import "../assets/scss/components/_colorpicker.scss";
</style>
