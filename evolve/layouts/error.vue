			...
			<div class="uk-width-1-2@l uk-width-2-3@m">
				<div v-if="error.statusCode === 404">
					...
					<div class="sc-padding-large">
						<p>
							The requested URL
							<span class="md-color-red-800">{{ $route.path }}</span> was not found on this server.
						</p>
						<nuxt-link to="/">
							Go To Evolve Home Page
						</nuxt-link>
					</div>
				</div>
...
<style lang="scss">
@import "assets/scss/common/md_colors";
@import "assets/scss/common/variables_mixins";
#__nuxt,
#__layout,
#__layout > div {
  height: 100%;
