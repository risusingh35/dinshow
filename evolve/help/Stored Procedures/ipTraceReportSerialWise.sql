...
/****** Object:  StoredProcedure [dbo].[ipTraceReportSerialWise]    Script Date: 10/22/2019 4:22:56 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[ipTraceReportSerialWise] @SerialNo nvarchar(255) , @start int , @length int
AS
...
AND epod.EvolveProdOrdersDetail_Serial = @SerialNo
