...
module.exports = {
    ...
    addEDITemplateAttrMappingAuth: async function (req, res, next) {
        const rulesSchema = Evolve.Joi.object({

            EvolveEDITemplateAttrMapping_INTemplateID: Evolve.Joi.number().required(),
            EvolveEDITemplateAttrMapping_INTemplateAttrID: Evolve.Joi.number().required(),
            EvolveEDITemplateAttrMapping_OUTTemplateID: Evolve.Joi.number().required(),
            EvolveEDITemplateAttrMapping_OUTTemplateAttrID: Evolve.Joi.number().required(),
            EvolveEDITemplateAttrMapping_Status: Evolve.Joi.required(),
