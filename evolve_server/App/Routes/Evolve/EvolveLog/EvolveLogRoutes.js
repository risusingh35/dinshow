...
try {
  ...
  Evolve.Router.post('/api/v1/evolve/EvolveLog/getDirectoryTree', Evolve.App.Middlewares.EvolveCommonApiValidator.apiAuthorization,Evolve.App.Middlewares.Evolve.EvolveLog.MidList.getDirectoryTreeAuth, Evolve.App.Controllers.Evolve.EvolveLog.ConList.getDirectoryTree);
  ...
  Evolve.Router.post('/api/v1/evolve/EvolveLog/deleteResource', Evolve.App.Middlewares.EvolveCommonApiValidator.apiAuthorization,Evolve.App.Middlewares.Evolve.EvolveLog.MidList.deleteResourceAuth, Evolve.App.Controllers.Evolve.EvolveLog.ConList.deleteResource);
