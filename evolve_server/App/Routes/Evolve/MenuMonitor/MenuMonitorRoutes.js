...
try {
    ...
    Evolve.Router.post('/api/v1/evolve/MenuMonitor/getMenuMonitorList', Evolve.App.Middlewares.EvolveCommonApiValidator.apiAuthorization,  Evolve.App.Controllers.Evolve.MenuMonitor.ConList.getMenuMonitorList);
