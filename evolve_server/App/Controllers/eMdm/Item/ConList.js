...
module.exports = {
    ...
    getItemList: async function (req, res) {
        try {
            ...
            let Count = await Evolve.App.Services.eMdm.Item.SrvList.getItemListCount(search);
            let List = await Evolve.App.Services.eMdm.Item.SrvList.getItemList(start, length, search);
