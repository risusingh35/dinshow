...
module.exports = {
    ...
    getPrintProcessListOffline : async function (req, res) {
        try {
            ...
            let Count = await Evolve.App.Services.Evolve.printProcess.SrvListV1.getPrintProcessListOfflineCount(search);
            let result = await Evolve.App.Services.Evolve.printProcess.SrvListV1.getPrintProcessListOffline(start, length, search);
    ...
    onClickRePrint : async function (req,res) {
        try {
            ...
            let result = await Evolve.App.Services.Evolve.printProcess.SrvListV1.onClickRePrint(req.body);
    ...
    getAllPrinter : async function (req,res) {
        try {
            let getAllPrinter = await Evolve.App.Services.Evolve.printProcess.SrvListV1.getAllPrinter();
    ...
    requeueAllErrorLabels : async function (req,res) {
        try {
            ...
            let response = await Evolve.App.Services.Evolve.printProcess.SrvListV1.requeueAllErrorLabels(req.body.selectPrinter);
