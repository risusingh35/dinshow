...
module.exports = {
    ...
    getPrintProcessList : async function (req, res) {
        try {
            ...
            let Count = await Evolve.App.Services.Evolve.printProcess.SrvListInvoice.getPrintProcessListCount(search);
            let result = await Evolve.App.Services.Evolve.printProcess.SrvListInvoice.getPrintProcessList(start, length, search);
    ...
    onClickRePrint : async function (req,res) {
        try {
            ...
            let result = await Evolve.App.Services.Evolve.printProcess.SrvListInvoice.onClickRePrint(req.body);
    ...
    getAllPrinter : async function (req,res) {
        try {
            let getAllPrinter = await Evolve.App.Services.Evolve.printProcess.SrvListInvoice.getAllPrinter();
    ...
    rePrintAll : async function (req,res) {
        try {
            ...
            let response = await Evolve.App.Services.Evolve.printProcess.SrvListInvoice.rePrintAll(req.body.selectPrinter);
