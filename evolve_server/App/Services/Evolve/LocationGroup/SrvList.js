...
module.exports = {
    ...
    addLocationGroup: async function (data) {
        try {
            ...
            return await Evolve.SqlPool.request()
                ...
                .query("INSERT INTO EvolveLocationGroup (EvolveLocationGroup_Name, EvolveLocationGroup_Code, EvolveLocationGroup_Status,EvolveLocationGroup_CreatedAt, EvolveLocationGroup_CreatedUser, EvolveLocationGroup_UpdatedAt, EvolveLocationGroup_UpdatedUser)VALUES(@EvolveLocationGroup_Name, @EvolveLocationGroup_Code, @EvolveLocationGroup_Status, @EvolveLocationGroup_CreatedAt, @EvolveLocationGroup_CreatedUser, @EvolveLocationGroup_UpdatedAt, @EvolveLocationGroup_UpdatedUser)");
    ...
    getLocationGroupList: async function (start, length,search) {
        try {
            return await Evolve.SqlPool.request()
                .input('start', Evolve.Sql.Int, start)
                .input('length', Evolve.Sql.Int, length)
                .input('search', Evolve.Sql.NVarChar, '%'+search+'%')
                .query("SELECT * FROM EvolveLocationGroup WHERE EvolveLocationGroup_Name LIKE @search OR EvolveLocationGroup_Code LIKE @search ORDER BY EvolveLocationGroup_ID desc OFFSET @start ROWS FETCH NEXT @length ROWS ONLY");
