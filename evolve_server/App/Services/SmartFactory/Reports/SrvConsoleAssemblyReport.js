...
module.exports = {
    ...
    getConsoleAssyReportCountList: async function (data) {
        try {
            let startDate ;
            let endDate ;
            ...
            return await Evolve.SqlPool.request()
                ...
                .input('EvolveItemGroup_ID', Evolve.Sql.Int, 3)
    ...
    getConsoleAssyReportDatatableList : async function (start, length, data) {
        try {
            let startDate  = '';
            let endDate  = '';
            if(data.startDate != '' && data.endDate != '' ){
