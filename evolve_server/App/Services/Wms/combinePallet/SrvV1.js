...
module.exports = {
    ...
    getLocationCode: async function (EvolveLocation_ID) 
    {
        try {
            ...
            Evolve.Log.error(" EERR3185: Error while getting Location Code "+error.messageage);
            return new Error(" EERR3185: Error while getting Location Code "+error.messageage);
        }
    },	
    updateInventoryQty: async function (data,newQty) 
    {
        ...
        try {
            ...
            Evolve.Log.error(" EERR3186: Error while updating Inventory Qty "+error.messageage);
            return new Error(" EERR3186: Error while updating Inventory Qty "+error.messageage);
        }
    },	
    ...
    //     } catch (error) {
    //         Evolve.Log.error(" EERR3187: Error while adding Inventory "+error.messageage);
    //         return new Error(" EERR3187: Error while adding Inventory "+error.messageage);
    //     }
    // },	
    removeInventory: async function (EvolveInventory_ID) 
    {
        try {
            ...
            Evolve.Log.error(" EERR3188: Error while removing Inventory "+error.messageage);
            return new Error(" EERR3188: Error while removing Inventory "+error.messageage);
        }
    },
    ...
    getInvPalletNumber: async function (data) 
    {
        try {
            ...
            Evolve.Log.error(" EERR3189: Error while getting Inv Pallet Number "+error.messageage);
            return new Error(" EERR3189: Error while getting Inv Pallet Number "+error.messageage);
        }
    },
    ...
    updateInventoryPrint: async function (data) 
    {
        try {
            ...
            Evolve.Log.error(" EERR3190: Error while updating Inventory Print "+error.messageage);
            return new Error(" EERR3190: Error while updating Inventory Print "+error.messageage);
        }
    },
    ...
    addIOData: async function (data) 
	{
		try {
			...
			Evolve.Log.error(" EERR3191: Error while adding IO Data "+error.messageage);
			return new Error(" EERR3191: Error while adding IO Data "+error.messageage);
		}
    },
	...
	// 		return await Evolve.SqlPool.request()
	// 		.input("EvolveInventory_RefNumber", Evolve.Sql.NVarChar, data.EvolveInventory_RefNumber)
	// 		.query(" SELECT einv.*  , eloc.EvolveLocation_Name ,eloc.EvolveLocation_Code   , uom.EvolveUom_Uom  , ei.EvolveItem_Code , ei.EvolveItem_Desc FROM  EvolveInventory einv , EvolveLocation eloc  , EvolveUom uom ,EvolveItem ei  WHERE einv.EvolveInventory_PostingStatus != 'PENDING' AND einv.EvolveLocation_ID = eloc.EvolveLocation_ID AND ei.EvolveUom_ID= uom.EvolveUom_ID ANd einv.EvolveItem_ID = ei.EvolveItem_ID AND einv.EvolveInventory_RefNumber = @EvolveInventory_RefNumber " )
	// 	} catch (error) {
	// 		Evolve.Log.error("EERR3192 : Error while get pallet details "+error.message);
	// 		return new Error("EERR3192 : Error while get pallet details "+error.message);
	// 	}
    // },
    ...
    getCombinedPalletDetails: async function (EvolveInventory_ID) {
		try {
			return await Evolve.SqlPool.request()
			.input("EvolveInventory_ID", Evolve.Sql.NVarChar, EvolveInventory_ID)
			...
			Evolve.Log.error("EERR3193 : Error while get combined pallet details "+error.message);
			return new Error("EERR3193 : Error while get combined pallet details "+error.message);
		}
    },
    printPallet: async function (data) {
		...
		Evolve.Log.error(" EERR3230 : Error while print pallet "+error.message);
		return new Error(" EERR3230 : Error while print pallet "+error.message);
		}
	},
