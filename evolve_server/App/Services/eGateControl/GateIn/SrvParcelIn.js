        ...
        try {
            let dataTime = await Evolve.App.Controllers.Unit.unitControllers.getDateTime();
              return await Evolve.SqlPool.request()
                ...
                .input('EvolveGate_Direction', Evolve.Sql.NVarChar, "0")
            ...
            Evolve.Log.error(" EERR1120: Error while adding parcel data "+error.message);
            return new Error(" EERR1120: Error while adding parcel data "+error.message);
        }
    },
